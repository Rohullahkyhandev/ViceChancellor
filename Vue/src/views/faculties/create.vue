  ...
  <div class="mt-10 mb-10 w-full">
    ...
    <form @submit.prevent="onSubmit">
      <div class="w-full py-8 bg-white shadow mt-8 px-4">
        ...
        <div class="mt-5">
          ...
          <div class="md:flex md:items-center md:justify-center">
            <div class="w-2/12">
              <label class="form-label"
                >تاریخ تأسیس<span class="text-red-500 px-4">*</span></label
              >
            </div>
            <div class="md:w-6/12">
              <CustomInput
          ...
          <div class="md:flex items-center justify-center">
            <div class="md:w-2/12 md:items-center">
              <label class="form-label"
                >توضیحات<span class="text-red-500 px-4">*</span></label
              >
            </div>
      ...
      <footer class="bg-gray-100 py-4 md:flex gap-5">
        ...
        <router-link :to="{ name: 'app.faculty.list' }" class="footer-btn-red"
          >لغو ثبت</router-link
        >
      </footer>
    </form>
