<template>
    <div class="px-5 mt-10">
        <div class="flex items-center justify-between mb-8">
            <div>
                <router-link :to="{ name: 'app.student.create' }"
            ...
            <div>
                <h1 class=" font-bold text-xl ">لیست محصلین</h1>
            </div>
        </div>

        <div class="bg-white p-6 rounded shadow animate-fade-in-down overflow-auto">
            <!-- display message area -->
            <div class="bg-green-700 text-white rounded py-4 text-center mb-3" v-if="studentStore.msg_success">
            ...
            <div class="bg-red-500 text-white py-4 rounded text-center mb-3" v-if="studentStore.msg_wrang">
                <div class="flex items-center justify-between px-10">
                    <div
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div>
                    <input v-model="search" @change="getStudent(null)"
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <select dir="ltr" @change="getStudent(null)" v-model="perPage"
                    ...
                    <tr v-for="(student, index) of students.data" :key="index">
                        ...
                        <td class="border-b p-2 ">
                            <Menu as="div" class="relative inline-block text-left">
                                <div>
                                    <MenuButton
                                        class="inline-flex items-center  justify-center rounded-full w-10 h-10 bg-black bg-opacity-0 text-sm font-medium text-blue-800 hover:bg-opacity-5 focus:bg-opacity-5 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                                ...
                                <transition enter-active-class="transition duration-100 ease-out"
                                    ...
                                    <MenuItems
                                        class="absolute z-10 left-4 mt-2 w-32 origin-top-right  rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">


                                        <div class="px-1 py-1">
                                            <MenuItem v-slot="{ active }">
                                            <router-link :to="{ name: 'app.student.details', params: { id: student.id } }"
                                                :class="[
                                        ...
                                        <div class="px-1 py-1">
                                            <MenuItem v-slot="{ active }">
                                            <router-link :to="{ name: 'app.student.edit', params: { id: student.id } }"
                                                :class="[
                                                    active ? 'bg-blue-800 text-white' : 'text-gray-900',
                                                    'group flex w-full items-center rounded-md gap-3 px-2 py-2 text-sm',
                                                ]">
            ...
            <div v-if="!students.loading" class="flex justify-between items-center mt-5" dir="ltr">
                <div v-if="students.data">
                    نمایش از {{ students.from }} تا {{ students.to }}
                </div>
                <nav v-if="students.total > students.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination">
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a v-for="(link, i) of students.links" :key="i" :disabled="!link.url" href="#"
