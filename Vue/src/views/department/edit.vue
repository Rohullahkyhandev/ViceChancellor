      ...
      <div class="w-full py-8 bg-white shadow mt-8 px-4">
        ...
        <div>
          <div class="border-b py-2">
            <h1 class="font-bold text-xl">فورم ویرایش اطلاعات دیپارتمنت</h1>
          </div>
        </div>
        <div class="mt-5">
          ...
          <div class="md:flex items-center justify-center">
            <div class="w-2/12">
              <label class="form-label"
                >تاریخ تأسیس<span class="text-red-500 px-2">*</span></label
              >
            </div>
            <div class="md:w-6/12">
              <CustomInput
          ...
          <div class="md:flex items-center justify-center">
            <div class="md:w-2/12 md:items-center">
              <label class="form-label"
                >توضیحات<span class="text-red-500 px-2">*</span></label
              >
            </div>
            <div class="md:w-6/12">
              <CustomInput
...
onMounted(() => {
  departmentStore.getDepartment(route.params.id);
});

const department = computed(() => departmentStore.department);

function onSubmit() {
  departmentStore.editDepartment(department.value);
  router.push({ name: "app.faculty.details", params: { id: route.params.id } });
