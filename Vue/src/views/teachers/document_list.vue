<template>
    <div class=" mt-10">
        ...
        <div class="mt-5 mb-4 flex items-center justify-between">
            <router-link class="btn-all" :to="{ name: 'app.document.create', params: { id: props.id } }">
        ...
        <div class="bg-white p-6 rounded shadow animate-fade-in-down overflow-auto">
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div>
                    <input v-model="search" @change="getDocuments(null)"
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <select dir="ltr" @change="getDocuments(null)" v-model="perPage"
                    ...
                    &nbsp;
                    <span class="ml-3">پیداشد {{ documents.total }} دیتا</span>
                </div>
            </div>
            <table class="table-auto w-full">
                ...
                <tbody v-else>
                    <tr v-for="(document, index) of documents.data">
                        ...
                        <td class="border-b p-2">
                            <a :href="document.attachment_path" target="__blank" class="hover:text-blue-600 bg-blue-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                ...
                                <transition enter-active-class="transition duration-100 ease-out"
                                    ...
                                    <MenuItems
                                        ...
                                        <div class="px-1 py-1">
                                            ...
                                            <router-link
                                                :to="{ name: 'app.document.edit', params: { id: document.id, t_id: $route.params.id } }"
                                                :class="[
                                        ...
                                        <div class="px-1 py-1">
                                            <MenuItem v-slot="{ active }">
                                            <button @click="deleteDocument(document.id)" :class="[
                                                active ? 'bg-blue-800 text-white' : 'text-gray-900',
                                                'group flex w-full items-center rounded-md gap-3 px-2 py-2 text-sm',
                                            ]">
                ...
                <nav v-if="documents.total > documents.limit"
                    ...
                    <a v-for="(link, i) of documents.links" :key="i" :disabled="!link.url" href="#"
                        ...
                        :class="[
                            ...
                            i === 0 ? 'rounded-l-md' : '',
                            i === documents.links.length - 1 ? 'rounded-r-md' : '',
...
const search = ref('');
const documents = computed(() => teacherStore.Documents);
...
function getForPage(ev, link) {
    ...
    getDocuments(link.url)
}

function getDocuments(url = null) {
    teacherStore.getDocuments({
        id: route.params.id,
        url,
        search: search.value,
...
function deleteDocument(id) {
    if (!confirm(`آیا شما میخواهید این دیتا حذف نماید؟`)) {
        return
    }
