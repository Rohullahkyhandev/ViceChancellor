<template>
    <div class="mt-10 mb-10 w-full">
        <div class="flex items-center justify-between w-full">
            <div>
                <router-link :to="{ name: 'app.faculty.list' }" class="btn-all">
            ...
            <div>
                <h1 class="font-bold text-xl">فورم ویرایش اطلاعات استادان</h1>
            </div>
        </div>
        ...
        <form @submit.prevent="onSubmit">
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div class="md:flex md:items-center md:justify-center">
                    ...
                    <div class="md:w-6/12">
                        <CustomInput type="select" :selectOptions="faculties" v-model="teacher.faculty_id" class="mb-2"
                            required="required" label="فاکولته" />
                    </div>
                </div>
            ...
            <footer class="bg-gray-100 py-4  md:flex gap-5">
                ...
                <router-link :to="{ name: 'app.teacher.list' }" class="footer-btn-red">لغو
                    ثبت</router-link>
            </footer>
        </form>
...
onMounted(() => {
    ...
    teacherStore.getDepartments(route.params.id);
})
