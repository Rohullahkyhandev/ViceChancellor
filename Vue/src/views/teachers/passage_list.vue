<template>
    <div class="">
        ...
        <div class="mt-5 mb-5 flex items-center justify-between">
            <router-link class="btn-all" :to="{ name: 'app.teacher.article.create', params: { id: props.id } }">
        ...
        <div class="bg-white p-6 rounded shadow animate-fade-in-down overflow-auto">
            ...
            <div class="bg-green-500 text-white rounded py-4 text-center mb-3" v-if="teacherStore.msg_asuccess">
            ...
            <div class="bg-red-500 text-white py-4 rounded text-center mb-3" v-if="teacherStore.msg_awrang">
                <div class="flex items-center justify-between px-10">
                    <div
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <select dir="ltr" @change="getArticles(null)" v-model="perPage"
                    ...
                    &nbsp;
                    <span class="ml-3">پیداشد {{ articles.total }} دیتا</span>
                </div>
            </div>
            <table class="table-auto w-full">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell field="action" :sortDirection="sortDirection" :sortField="sortField"
                            @click="sortUsers('acs')">
                            کابر
                        </TableHeaderCell requirements for applying in master degree in Torrento University for computer science?ell>
                ...
                <tbody v-else>
                    <tr v-for="(article, index) of articles.data">
                        ...
                        <td class="border-b p-2 ">
                            <a :href="article.publisher" class="hover:text-blue-600 ">
                                {{ article.publisher }}
                            </a>
                        </td>
                        <td class="border-b p-2 ">
                                ...
                                <transition enter-active-class="transition duration-100 ease-out"
                                    ...
                                    <MenuItems
                                        ...
                                        <div class="px-1 py-1">
                                            ...
                                            <router-link
                                                :to="{ name: 'app.article.edit', params: { id:article.id, t_id: $route.params.id } }"
                                                :class="[
                                        ...
                                        <div class="px-1 py-1">
                                            <MenuItem v-slot="{ active }">
                                            <button @click="deleteArticle(article.id)" :class="[
                                                active ? 'bg-blue-800 text-white' : 'text-gray-900',
                                                'group flex w-full items-center rounded-md gap-3 px-2 py-2 text-sm',
                                            ]">
            ...
            <div v-if="!articles.loading" class="flex justify-between items-center mt-5" dir="ltr">
                <div v-if="articles.data">
                    نمایش از {{ articles.from }} تا {{ articles.to }}
                </div>
                <nav v-if="articles.total > articles.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination">
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a v-for="(link, i) of articles.links" :key="i" :disabled="!link.url" href="#"
...
const search = ref('');
const articles = computed(() => teacherStore.Articles);
...
function deleteArticle(id) {
    if (!confirm(`آیا میخواهید این دیتا را حذف نماید؟`)) {
        return
    }
